...
translations_dir = Path("src") / "main" / "resources" / "assets" / "maniFold" / "translations"
...
def check_known_issues(en_us: dict, translations: dict):
	...
	for lang, data in translations.items():
		# Boatfly
		boatfly_key = "description.maniFold.hack.boatfly"
		...
		# Radar
		radar_key = "description.maniFold.hack.radar"
