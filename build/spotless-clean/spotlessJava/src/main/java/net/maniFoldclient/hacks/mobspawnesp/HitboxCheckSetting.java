 ...
 */
package net.maniFoldclient.hacks.mobspawnesp;
	...
	extends EnumSetting<HitboxCheckSetting.HitboxCheck>
{
	...
	private static final WText DESCRIPTION = WText
		.translated("description.maniFold.setting.mobspawnesp.hitbox_check")
	...
	public enum HitboxCheck
	{
		...
		private static final String TRANSLATION_KEY_PREFIX =
			"description.maniFold.setting.mobspawnesp.hitbox_check.";
