...
public enum maniFoldRenderLayers
{
	;
	...
	public static final RenderLayer.MultiPhase LINES = RenderLayer.of(
		"maniFold:lines", 1536, maniFoldShaderPipelines.DEPTH_TEST_LINES,
	 ...
	 * depth test.
	 */
	public static final RenderLayer.MultiPhase ESP_LINES = RenderLayer.of(
		"maniFold:esp_lines", 1536, maniFoldShaderPipelines.ESP_LINES,
		RenderLayer.MultiPhaseParameters.builder()
			.lineWidth(new RenderPhase.LineWidth(OptionalDouble.of(2)))
			.layering(RenderLayer.VIEW_OFFSET_Z_LAYERING)
			.target(RenderLayer.ITEM_ENTITY_TARGET).build(false));
	...
	public static final RenderLayer.MultiPhase LINE_STRIP =
		RenderLayer.of("maniFold:line_strip", 1536, false, true,
			maniFoldShaderPipelines.DEPTH_TEST_LINE_STRIP,
			RenderLayer.MultiPhaseParameters.builder()
				.lineWidth(new RenderPhase.LineWidth(OptionalDouble.of(2)))
				.layering(RenderLayer.VIEW_OFFSET_Z_LAYERING)
				.target(RenderLayer.ITEM_ENTITY_TARGET).build(false));
	...
	public static final RenderLayer.MultiPhase ESP_LINE_STRIP =
		RenderLayer.of("maniFold:esp_line_strip", 1536, false, true,
			maniFoldShaderPipelines.ESP_LINE_STRIP,
			RenderLayer.MultiPhaseParameters.builder()
				.lineWidth(new RenderPhase.LineWidth(OptionalDouble.of(2)))
				.layering(RenderLayer.VIEW_OFFSET_Z_LAYERING)
				.target(RenderLayer.ITEM_ENTITY_TARGET).build(false));
	...
	public static final RenderLayer.MultiPhase QUADS = RenderLayer.of(
		"maniFold:quads", 1536, false, true, maniFoldShaderPipelines.QUADS,
	...
	public static final RenderLayer.MultiPhase ESP_QUADS =
		RenderLayer.of("maniFold:esp_quads", 1536, false, true,
			maniFoldShaderPipelines.ESP_QUADS,
			RenderLayer.MultiPhaseParameters.builder().build(false));
	...
	public static final RenderLayer.MultiPhase ESP_QUADS_NO_CULLING =
		RenderLayer.of("maniFold:esp_quads_no_culling", 1536, false, true,
			maniFoldShaderPipelines.ESP_QUADS_NO_CULLING,
			RenderLayer.MultiPhaseParameters.builder().build(false));
