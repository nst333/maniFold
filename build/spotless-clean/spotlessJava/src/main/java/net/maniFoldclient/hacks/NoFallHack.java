...
public final class NoFallHack extends Hack implements UpdateListener
{
	private final CheckboxSetting allowElytra =
		new CheckboxSetting("Allow elytra",
			"description.maniFold.setting.nofall.allow_elytra", false);
	
	private final CheckboxSetting pauseForMace =
		new CheckboxSetting("Pause for mace",
			"description.maniFold.setting.nofall.pause_for_mace", false);
	...
	{
		MANIFOLD.getHax().antiHungerHack.setEnabled(false);
