...
public final class AltManagerScreen extends Screen
{
	...
	public void init()
	{
		...
		{
			Text title = Text.literal(maniFold
				.translate("gui.maniFold.altmanager.folder_error.title"));
			Text message = Text.literal(maniFold.translate(
				"gui.maniFold.altmanager.folder_error.message",
				folderException));
		...
		}else if(altManager.getList().isEmpty() && shouldAsk)
		{
			Text title = Text.literal(
				maniFold.translate("gui.maniFold.altmanager.empty.title"));
			Text message = Text.literal(
				maniFold.translate("gui.maniFold.altmanager.empty.message"));
