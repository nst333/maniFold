...
import net.maniFoldclient.other_features.TabGuiOtf;
...
public final class TabGui implements KeyPressListener
{
	...
	private final TabGuiOtf tabGuiOtf =
		maniFoldClient.INSTANCE.getOtfs().tabGuiOtf;
	...
	public TabGui()
	{
		MANIFOLD.getEventManager().add(KeyPressListener.class, this);
	...
	public void render(DrawContext context, float partialTicks)
	{
		...
		int textY = 1;
		int txtColor = MANIFOLD.getGui().getTxtColor();
