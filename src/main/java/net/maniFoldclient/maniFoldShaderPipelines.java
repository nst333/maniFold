...
public enum maniFoldShaderPipelines
{
	;
	...
	public static final Snippet FOGLESS_LINES_SNIPPET = RenderPipeline
		...
		.withVertexShader(Identifier.of("manifold:core/fogless_lines"))
		.withFragmentShader(Identifier.of("manifold:core/fogless_lines"))
	...
	public static final RenderPipeline DEPTH_TEST_LINES =
		RenderPipelines.register(RenderPipeline.builder(FOGLESS_LINES_SNIPPET)
			.withLocation(
				Identifier.of("manifold:pipeline/manifold_depth_test_lines"))
			.build());
	...
	public static final RenderPipeline ESP_LINES =
		RenderPipelines.register(RenderPipeline.builder(FOGLESS_LINES_SNIPPET)
			.withLocation(Identifier.of("manifold:pipeline/manifold_esp_lines"))
	...
	public static final RenderPipeline DEPTH_TEST_LINE_STRIP =
		RenderPipelines.register(RenderPipeline.builder(FOGLESS_LINES_SNIPPET)
			.withLocation(
				Identifier.of("manifold:pipeline/manifold_depth_test_line_strip"))
	...
	public static final RenderPipeline ESP_LINE_STRIP =
		RenderPipelines.register(RenderPipeline.builder(FOGLESS_LINES_SNIPPET)
			.withLocation(Identifier.of("manifold:pipeline/manifold_esp_line_strip"))
			.withVertexFormat(VertexFormats.POSITION_COLOR_NORMAL,
				DrawMode.LINE_STRIP)
			.withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).build());
	...
	public static final RenderPipeline QUADS = RenderPipelines
		.register(RenderPipeline.builder(RenderPipelines.POSITION_COLOR_SNIPPET)
			.withLocation(Identifier.of("manifold:pipeline/manifold_quads"))
	...
	public static final RenderPipeline ESP_QUADS = RenderPipelines
		.register(RenderPipeline.builder(RenderPipelines.POSITION_COLOR_SNIPPET)
			.withLocation(Identifier.of("manifold:pipeline/manifold_esp_quads"))
			.withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST).build());
