 ...
 */
package net.maniFoldclient.altmanager;
...
public final class Encryption
{
	...
	public Encryption(Path encFolder) throws IOException
	{
		...
		KeyPair rsaKeyPair =
			getRsaKeyPair(encFolder.resolve("maniFold_rsa_public.txt"),
				encFolder.resolve("maniFold_rsa_private.txt"));
		
		SecretKey aesKey =
			getAesKey(encFolder.resolve("maniFold_aes.txt"), rsaKeyPair);
	...
	private Path createEncryptionFolder(Path encFolder) throws IOException
	{
		...
		String readmeText = "DO NOT SHARE THESE FILES WITH ANYONE!\r\n"
			...
			+ "If you do, maniFold's Alt Manager can no longer read your alt list and will replace it with a blank one.\r\n"
	...
	public static Path chooseEncryptionFolder()
	{
		...
		String encFolderName = ".maniFold encryption";
	...
	public static void migrateEncryptionFolder(Path oldFolder, Path newFolder)
	{
		...
		{
			CrashReport report =
				CrashReport.create(e, "Migrating maniFold encryption folder");
