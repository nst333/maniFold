...
import net.maniFoldclient.hacks.mobspawnesp.HitboxCheckSetting;
import net.maniFoldclient.settings.CheckboxSetting;
import net.maniFoldclient.settings.ChunkAreaSetting;
import net.maniFoldclient.settings.ChunkAreaSetting.ChunkArea;
...
import net.maniFoldclient.util.chunk.ChunkVertexBufferCoordinator;
	...
	implements UpdateListener, RenderListener
{
	...
	private final ColorSetting nightColor = new ColorSetting("Night color",
		"description.maniFold.setting.mobspawnesp.night_color", Color.YELLOW);
	
	private final ColorSetting dayColor = new ColorSetting("Day color",
		"description.maniFold.setting.mobspawnesp.day_color", Color.RED);
	...
	public void onRender(MatrixStack matrixStack, float partialTicks)
	{
		RenderLayer.MultiPhase layer =
			maniFoldRenderLayers.getLines(depthTest.isChecked());
