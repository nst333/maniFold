...
import net.maniFoldclient.hacks.templatetool.Area;
import net.maniFoldclient.hacks.templatetool.ChooseNameScreen;
import net.maniFoldclient.hacks.templatetool.Step;
import net.maniFoldclient.hacks.templatetool.Template;
	...
	implements UpdateListener, RenderListener, GUIRenderListener
{
	...
	public void onEnable()
	{
		...
		MANIFOLD.getHax().autoBuildHack.setEnabled(false);
		MANIFOLD.getHax().bowAimbotHack.setEnabled(false);
