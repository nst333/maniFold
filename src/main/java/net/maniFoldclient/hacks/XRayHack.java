...
import net.maniFoldclient.events.GetAmbientOcclusionLightLevelListener;
import net.maniFoldclient.events.RenderBlockEntityListener;
import net.maniFoldclient.events.SetOpaqueCubeListener;
import net.maniFoldclient.events.ShouldDrawSideListener;
import net.maniFoldclient.events.UpdateListener;
import net.maniFoldclient.hack.Hack;
import net.maniFoldclient.mixinterface.ISimpleOption;
	...
	ShouldDrawSideListener, RenderBlockEntityListener
{
	...
	private final String renderName =
		Math.random() < 0.01 ? "X-maniFold" : getName();
	...
	protected void onDisable()
	{
		...
		// reset gamma
		FullbrightHack fullbright = MANIFOLD.getHax().fullbrightHack;
