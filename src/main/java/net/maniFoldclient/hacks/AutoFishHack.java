...
import net.maniFoldclient.hacks.autofish.AutoFishDebugDraw;
import net.maniFoldclient.hacks.autofish.AutoFishRodSelector;
import net.maniFoldclient.hacks.autofish.FishingSpotManager;
import net.maniFoldclient.hacks.autofish.ShallowWaterWarningCheckbox;
	...
	implements UpdateListener, PacketInputListener, RenderListener
{
	...
	protected void onEnable()
	{
		...
		MANIFOLD.getHax().antiAfkHack.setEnabled(false);
