...
import net.maniFoldclient.hacks.autocomplete.MessageCompleter;
import net.maniFoldclient.hacks.autocomplete.ModelSettings;
import net.maniFoldclient.hacks.autocomplete.OpenAiMessageCompleter;
import net.maniFoldclient.hacks.autocomplete.SuggestionHandler;
	...
	implements ChatOutputListener, UpdateListener
{
	...
	protected void onEnable()
	{
		...
		if(completer instanceof OpenAiMessageCompleter
			&& System.getenv("MANIFOLD_OPENAI_KEY") == null)
		{
			ChatUtils.error("API key not found. Please set the"
				+ " MANIFOLD_OPENAI_KEY environment variable and reboot.");
			setEnabled(false);
			return;
		}
