...
import net.maniFoldclient.hacks.autolibrarian.BookOffer;
import net.maniFoldclient.hacks.autolibrarian.UpdateBooksSetting;
...
import net.maniFoldclient.util.*;
	...
	implements UpdateListener, RenderListener
{
	...
	private void breakJobSite()
	{
		...
		// equip tool
		MANIFOLD.getHax().autoToolHack.equipBestTool(jobSite, false, true,
