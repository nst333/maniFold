	...
	implements UpdateListener, RenderListener
{
	...
	protected void onEnable()
	{
		...
		MANIFOLD.getHax().followHack.setEnabled(false);
		MANIFOLD.getHax().instantBunkerHack.setEnabled(false);
	...
	public void onRender(MatrixStack matrixStack, float partialTicks)
	{
		...
		for(EasyVertexBuffer buffer : vertexBuffers)
		{
			...
			buffer.draw(matrixStack, maniFoldRenderLayers.ESP_LINES);
		}
	...
	private class DigTunnelTask extends Task
	{
		...
		public void run()
		{
			...
			MANIFOLD.getHax().autoToolHack.equipBestTool(currentBlock, false, true,
				0);
	...
	private class WalkForwardTask extends Task
	{
		...
		public void run()
		{
			...
			MANIFOLD.getRotationFaker().faceVectorClientIgnorePitch(vec);
	...
	private class DodgeLiquidTask extends Task
	{
		...
		public void run()
		{
			...
			MANIFOLD.getRotationFaker().faceVectorClientIgnorePitch(toVec3d(pos3));
	...
	private boolean breakBlock(BlockPos pos)
	{
		...
		// face block
		MANIFOLD.getRotationFaker().faceVectorPacket(hitVecs[side.ordinal()]);
