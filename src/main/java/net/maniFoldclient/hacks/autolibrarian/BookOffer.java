 ...
 */
package net.maniFoldclient.hacks.autolibrarian;
	...
	implements Comparable<BookOffer>
{
	...
	{
		DynamicRegistryManager drm = maniFoldClient.MC.world.getRegistryManager();
	...
	{
		if(maniFoldClient.MC.world == null)
	...
	public String getEnchantmentName()
	{
		...
		if(description.getContent() instanceof TranslatableTextContent tr)
			return maniFoldClient.INSTANCE.getTranslator()
