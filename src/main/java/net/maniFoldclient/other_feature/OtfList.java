 ...
 */
package net.maniFoldclient.other_feature;
...
import net.maniFoldclient.other_features.*;
...
public final class OtfList
{
	...
	public final maniFoldCapesOtf maniFoldCapesOtf = new maniFoldCapesOtf();
	public final maniFoldLogoOtf maniFoldLogoOtf = new maniFoldLogoOtf();
	...
	public OtfList()
	{
		...
		{
			String message = "Initializing other maniFold features";
