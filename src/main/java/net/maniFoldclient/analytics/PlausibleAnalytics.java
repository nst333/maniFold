 ...
 */
package net.maniFoldclient.analytics;
...
public final class PlausibleAnalytics
{
	...
	private static final String MOD_ID = "maniFold";
	private static final URI API_ENDPOINT =
		URI.create("https://plausible.maniFoldclient.net/api/event");
	...
	public PlausibleAnalytics(Path configFile)
	{
		...
		sessionProp("version", getVersion("maniFold"));
		sessionProp("short_version", getShortVersion("maniFold"));
	...
	private boolean isDebugMode()
	{
		return FabricLoader.getInstance().isDevelopmentEnvironment()
			|| System.getProperty("maniFold.e2eTest") != null;
	}
