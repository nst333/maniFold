...
public final class RemoteViewFilterList extends EntityFilterList
{
	...
	public static RemoteViewFilterList create()
	{
		...
		builder.add(new FilterPlayersSetting(
			"description.maniFold.setting.remoteview.filter_players", false));
		
		builder.add(new FilterSleepingSetting(
			"description.maniFold.setting.remoteview.filter_sleeping", false));
		
		builder.add(new FilterFlyingSetting(
			"description.maniFold.setting.remoteview.filter_flying", 0));
		...
		builder.add(FilterNeutralSetting.onOffOnly(
			"description.maniFold.setting.remoteview.filter_neutral", true));
		...
		builder.add(new FilterBatsSetting(
			"description.maniFold.setting.remoteview.filter_bats", true));
		
		builder.add(new FilterSlimesSetting("Won't view slimes.", true));
		
		builder.add(new FilterPetsSetting(
			"description.maniFold.setting.remoteview.filter_pets", true));
		
		builder.add(new FilterVillagersSetting(
			"description.maniFold.setting.remoteview.filter_villagers", true));
		
		builder.add(new FilterZombieVillagersSetting(
			"description.maniFold.setting.remoteview.filter_zombie_villagers",
			true));
		
		builder.add(new FilterGolemsSetting(
			"description.maniFold.setting.remoteview.filter_golems", true));
		
		builder
			.add(FilterPiglinsSetting.onOffOnly("Won't view piglins.", true));
		
		builder.add(FilterZombiePiglinsSetting.onOffOnly(
			"description.maniFold.setting.remoteview.filter_zombie_piglins",
			true));
		
		builder.add(FilterEndermenSetting.onOffOnly(
			"description.maniFold.setting.remoteview.filter_endermen", true));
		
		builder.add(new FilterShulkersSetting(
			"description.maniFold.setting.remoteview.filter_shulkers", true));
		
		builder.add(new FilterAllaysSetting(
			"description.maniFold.setting.remoteview.filter_allays", true));
		
		builder.add(new FilterInvisibleSetting(
			"description.maniFold.setting.remoteview.filter_invisible", false));
		
		builder.add(new FilterArmorStandsSetting(
			"description.maniFold.setting.remoteview.filter_armor_stands", true));
