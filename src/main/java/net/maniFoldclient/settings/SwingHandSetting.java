	...
	extends EnumSetting<SwingHandSetting.SwingHand>
{
	...
	public static WText genericMiningDescription(Hack hack)
	{
		return WText.translated(
			"description.maniFold.setting.generic.swing_hand_mining",
			hack.getName());
	}
	...
	{
		return WText.translated(
			"description.maniFold.setting.generic.swing_hand_combat",
			hack.getName());
	}
	
	private static WText hackDescription(Hack hack)
	{
		return WText.translated("description.maniFold.setting."
	...
	public enum SwingHand
	{
		...
		private static final String TRANSLATION_KEY_PREFIX =
			"description.maniFold.setting.generic.swing_hand.";
