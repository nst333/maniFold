...
public final class maniFoldE2ETestClient implements ModInitializer
{
	@Override
	public void onInitialize()
	{
		if(System.getProperty("maniFold.e2eTest") == null)
			return;
		
		Thread.ofVirtual().name("maniFold End-to-End Test")
	...
	{
		System.out.println("Starting maniFold End-to-End Tests");
