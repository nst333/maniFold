...
{
	private final ClientPlayerEntity player = maniFoldClient.MC.player;
	private final ClientWorld world = maniFoldClient.MC.world;
	private PlayerListEntry playerListEntry;
	
	public FakePlayerEntity()
	{
		super(maniFoldClient.MC.world, maniFoldClient.MC.player.getGameProfile());
