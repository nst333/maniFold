 ...
 */
package net.maniFoldclient.clickgui;
...
import net.maniFoldclient.clickgui.components.FeatureButton;
import net.maniFoldclient.hacks.ClickGuiHack;
...
public final class ClickGui
{
	...
	public void init()
	{
		...
		features.addAll(MANIFOLD.getHax().getAllHax());
		features.addAll(MANIFOLD.getCmds().getAllCmds());
		features.addAll(MANIFOLD.getOtfs().getAllOtfs());
		...
		uiSettings.add(new FeatureButton(MANIFOLD.getOtfs().maniFoldLogoOtf));
		uiSettings.add(new FeatureButton(MANIFOLD.getOtfs().hackListOtf));
		uiSettings.add(new FeatureButton(MANIFOLD.getOtfs().keybindManagerOtf));
		ClickGuiHack clickGuiHack = MANIFOLD.getHax().clickGuiHack;
		...
		windows.add(maniFoldClient.INSTANCE.getHax().radarHack.getWindow());
	...
	{
		ClickGuiHack clickGui = MANIFOLD.getHax().clickGuiHack;
		...
		if(maniFoldClient.INSTANCE.getHax().rainbowUiHack.isEnabled())
