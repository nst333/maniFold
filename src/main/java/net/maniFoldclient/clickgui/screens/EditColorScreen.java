 ...
 */
package net.maniFoldclient.clickgui.screens;
...
import net.maniFoldclient.util.ColorUtils;
...
public final class EditColorScreen extends Screen
{
	...
	private final Identifier paletteIdentifier =
		Identifier.of("manifold", "colorpalette.png");
		...
		float partialTicks)
	{
		...
		context.drawCenteredTextWithShadow(client.textRenderer,
			colorSetting.getName(), width / 2, 16, maniFoldColors.VERY_LIGHT_GRAY);
