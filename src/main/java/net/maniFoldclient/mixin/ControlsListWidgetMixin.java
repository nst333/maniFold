...
{
	public ControlsListWidgetMixin(maniFoldClient maniFold, MinecraftClient client,
	...
	/**
	 * Prevents maniFold's zoom keybind from being added to the controls list.
	 */
		...
		EntryListWidget.Entry<?> entry, Operation<Integer> original)
	{
		...
		if(!"key.maniFold.zoom".equals(trContent.getKey()))
			return original.call(instance, entry);
