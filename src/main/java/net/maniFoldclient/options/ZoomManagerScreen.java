...
import net.maniFoldclient.other_features.ZoomOtf;
...
public class ZoomManagerScreen extends Screen implements PressAKeyCallback
{
	...
	public void init()
	{
		...
		ZoomOtf zoom = maniFold.getOtfs().zoomOtf;
	...
	{
		ZoomOtf zoom = maniFoldClient.INSTANCE.getOtfs().zoomOtf;
		CheckboxSetting scroll = zoom.getScrollSetting();
		...
		float partialTicks)
	{
		...
		context.drawTextWithShadow(textRenderer,
			...
			height / 4 + 44, maniFoldColors.VERY_LIGHT_GRAY);
	...
	{
		maniFoldClient.INSTANCE.getOtfs().zoomOtf.setBoundKey(key);
