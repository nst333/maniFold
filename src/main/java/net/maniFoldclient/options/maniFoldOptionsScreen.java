...
public class maniFoldOptionsScreen extends Screen
{
	...
	private void addLinkButtons()
	{
		...
		new maniFoldOptionsButton(54, 48, () -> "maniFold Wiki", "§n§lmaniFold.Wiki",
			b -> os.open("https://www.maniFoldclient.net/options-wiki/"));
		
		new maniFoldOptionsButton(54, 72, () -> "maniFoldForum", "§n§lmaniFoldForum.net",
		...
		int mouseY)
	{
		...
		{
			if(!button.isSelected() || !(button instanceof maniFoldOptionsButton))
				continue;
