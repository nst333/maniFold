...
public final class KeybindProfilesScreen extends Screen
{
	...
	public void init()
	{
		listGui = new ListGui(client, this,
			maniFoldClient.INSTANCE.getKeybinds().listProfiles());
	...
	private void openFolder()
	{
		Util.getOperatingSystem().open(
			maniFoldClient.INSTANCE.getKeybinds().getProfilesFolder().toFile());
	}
	...
	private void newProfile(String name)
	{
		...
		try
		{
			maniFoldClient.INSTANCE.getKeybinds().saveProfile(name);
	...
	private void loadSelected()
	{
		...
		try
		{
			...
			maniFoldClient.INSTANCE.getKeybinds().loadProfile(fileName);
			client.setScreen(prevScreen);
