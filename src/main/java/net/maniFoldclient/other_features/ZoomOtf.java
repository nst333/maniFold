...
import net.maniFoldclient.events.MouseScrollListener;
...
import net.maniFoldclient.settings.TextFieldSetting;
...
public final class ZoomOtf extends OtherFeature implements MouseScrollListener
{
	...
	private final TextFieldSetting keybind = new TextFieldSetting("Keybind",
		"Determines the zoom keybind.\n\n"
			+ "Instead of editing this value manually, you should go to maniFold"
	...
	public ZoomOtf()
	{
		super("Zoom", "Allows you to zoom in.\n"
			...
			+ "Go to maniFold Options -> Zoom to change this keybind.");
		addSetting(level);
		addSetting(scroll);
