...
@SearchTags({"maniFold logo", "top left corner"})
@DontBlock
public final class maniFoldLogoOtf extends OtherFeature
{
	...
	public maniFoldLogoOtf()
	{
		super("maniFoldLogo", "Shows the maniFold logo and version on the screen.");
		addSetting(bgColor);
		addSetting(txtColor);
	...
	public static enum Visibility
	{
		...
		ONLY_OUTDATED("Only when outdated",
			() -> MANIFOLD.getUpdater().isOutdated());
