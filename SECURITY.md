...
Generally, maniFold Client versions for the latest Minecraft release and for the latest Minecraft snapshot are supported.

Older versions are decided on a case-by-case basis, depending on the severity of the exploit. ![](https://img.wimods.net/github.com/maniFold-Imperium/maniFold7/SECURITY.md)

## Reporting a Vulnerability

You can report a vulnerability by sending an email to contact.maniFoldimperium@gmail.com.
